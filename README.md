# BERT + GNN for Social Studies Question Answering (SSQA)
...
1. The answer is a compound noun
    + Question: 「阿拉伯之春」運動中，發揮影響力的是那些社群媒體? 
                (Which social media platforms have a large influence on the Arab Spring Revolutions?)
    + 
